# Future B working rules

This repository is the Future B live extract. It is not the inverse / 11A
Keldysh4ai line.

1. Read `FUTURE_B.md` then `notes/CONSTRAINTS_FUTURE_B.md`.
2. `notes/SCIENCE_LINE_60DAY.md` wins scientific-order conflicts.
3. Process: tests + CSV + short `AGENT_LOG.md`. Nothing else.
4. No new K4AI IDs, extra worktrees, Freeze/CERTIFY, or 592/593 admission.
