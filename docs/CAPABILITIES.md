...
| Opt-in fixes of three native external-pair bugs (two new; one is the C0 defect); exact Future B moves; Docker driver; pooled estimator | source transform + Python drivers; no speedup claim | `future_b.fepdmc`, `future-b-fepdmc`, [FEP_DMC_TOOLKIT.md](FEP_DMC_TOOLKIT.md) |
