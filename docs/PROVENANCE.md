...
|---|---|---|
| **A. Public repository source** | the GitHub tree you cloned (`v1.3.1`) | this checkout; `release/v1.3.1/` |
...
Canonical machine-readable record: [`release/v1.3.1/PROVENANCE.json`](../release/v1.3.1/PROVENANCE.json).
Current-tree checksums: [`release/v1.3.1/SHA256SUMS.txt`](../release/v1.3.1/SHA256SUMS.txt).
v1.0.2, v1.0.3, v1.1.0, v1.2.0, and v1.3.0 provenance records are historical and immutable.
